...
function setLanguage(patientName, birthdate) {
    ...
    if (!english) {
        ...
        instructions = '<p>Las preguntas se refieren a la conducta de su hijo/a en general y no &uacute;nicamente en los &uacute;ltimos d&iacute;as, ya que en ese caso, la conducta de su hijo/a, puede haber estado algo alterada si &eacute;l o ella no se encuentran bien estos &uacute;ltimos d&iacuteas por cualquier motivo. Si hay alguna pregunta que no sabe como contestar, por favor consulte con su mujer, su marido, su hijo/a o con su m&eacute;dico.  Cuando en alguna pregunta Vd lea â€œhabitualmenteâ€?, quiere decir â€œm&aacute;s de la mitad de las vecesâ€? o â€œm&aacute;s de la mitad de las nochesâ€?.</p>';
