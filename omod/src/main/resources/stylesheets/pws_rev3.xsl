            ...
            <body>      	
		        <div class="main_container">
		            <form id="pwsForm" name="pwsForm" action="pws.form" method="post">            
						...
						<div class="psf_container">
							<div id="quality_indicators_header" class="header_bar">
								<b>Quality Indicators</b>
							</div>
							<div class="psf_results" id="qualityIndicators">
												...
												<td align="left" style="width: 50;">
													<xsl:choose>
														<xsl:when test="Records/Record/Field[@id = 'Special_Need']/Value = 'yes'">
															<input type="checkbox" name="Special_Need" value="yes" disabled="disabled" checked="checked"/>Special Need Child
														</xsl:when>
														<xsl:otherwise>
															<input type="checkbox" name="Special_Need" value="yes" disabled="disabled"/>Special Need Child
														</xsl:otherwise>
													</xsl:choose>
												</td>
											</tr>
												...
												<td align="left" style="width: 50;">
													<xsl:choose>
														<xsl:when test="Records/Record/Field[@id = 'MDTwoIDsChecked']/Value = 'Y'">
															<input type="checkbox" name="MDTwoIDsChecked" value="Y" disabled="disabled" checked="checked"/>Two ID's Checked
														</xsl:when>
														<xsl:otherwise>
															<input type="checkbox" name="MDTwoIDsChecked" value="Y" disabled="disabled"/>Two ID's Checked
														</xsl:otherwise>
													</xsl:choose>
												</td>
											</tr>
												...
												<td align="left" style="width: 50;">
													<xsl:choose>
														<xsl:when test="Records/Record/Field[@id = 'screenedForAbuse']/Value = 'screened'">
															<input type="checkbox" name="screenedForAbuse" value="screened" disabled="disabled" checked="checked"/>Screened for abuse
														</xsl:when>
														<xsl:otherwise>
															<input type="checkbox" name="screenedForAbuse" value="screened" disabled="disabled"/>Screened for abuse
														</xsl:otherwise>
													</xsl:choose>
												</td>
											</tr>
												...
												<td align="left" style="width: 50;">
													<xsl:choose>
														<xsl:when test="Records/Record/Field[@id = 'discussedHealthyDiet']/Value = 'Healthy Diet'">
															<input type="checkbox" name="discussedHealthyDiet" value="Healthy Diet" disabled="disabled" checked="checked"/>Discussed healthy diet
														</xsl:when>
														<xsl:otherwise>
															<input type="checkbox" name="discussedHealthyDiet" value="Healthy Diet" disabled="disabled"/>Discussed healthy diet
														</xsl:otherwise>
													</xsl:choose>
												</td>
											</tr>
												...
												<td align="left" style="width: 50;">
													<xsl:choose>
														<xsl:when test="Records/Record/Field[@id = 'discussedPhysicalActivity']/Value = 'Physical Activity'">
															<input type="checkbox" name="discussedPhysicalActivity" value="Physical Activity" disabled="disabled" checked="checked"/>Discussed physical activity
														</xsl:when>
														<xsl:otherwise>
															<input type="checkbox" name="discussedPhysicalActivity" value="Physical Activity" disabled="disabled"/>Discussed physical activity
														</xsl:otherwise>
													</xsl:choose>
												</td>
											</tr>
								...
								<div class="medication_education_container">
									<span>Medication Education Performed and/or Counseled on Vaccines</span>
									<span> 
										 <xsl:choose>
						...
						<div class="psf_container">
							...
							<div class="pws_prompts" id="pws_prompts">
								<table width="691" border="0" class="pws_prompts_table">
									<tbody>
										<tr>
											<xsl:choose>
