...
public class parentName implements Rule
{
			...
			Map<String, Object> parameters) throws LogicException
	{
		...
		PersonAttribute parentNameAttribute = patient.getAttribute("Next of Kin");
		
		if (parentNameAttribute != null && parentNameAttribute.getValue() != null){		
			nok = parentNameAttribute.getValue();
		}
		
		if(nok != null && nok.length()>0)
		{
			name = nok.replace("|", " ");
			name = Util.toProperCase(name); 
		} else {
			name = "";
		}
