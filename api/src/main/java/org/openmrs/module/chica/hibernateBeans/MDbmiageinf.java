...
/**
 * Holds information to store in the chica_md_bmiage table
 * 
 * @author Seema Sarala
 * @version 1.0
 */
public class MDbmiageinf implements java.io.Serializable, MDPercentile {

    private static final long serialVersionUID = 1L;
    // Fields
    private Integer mdbmiageinfId = null;
    ...
    private Double gtBelowMean = null;

    /**
     * @return the mdbmiageinfId
     */
    public Integer getMdbmiageinfId()
    {
        return this.mdbmiageinfId;
    }

    /**
     * @param mdbmiageinfId the mdbmiageinfId to set
     */
    public void setMdbmiageinfId(Integer mdbmiageinfId)
    {
        this.mdbmiageinfId = mdbmiageinfId;
    }
    ...
    /**
     * @return the gtBelowMean
     */
    public Double getGtBelowMean()
    {
        return this.gtBelowMean;
    }

    /**
     * @param gtBelowMean the gtBelowMean to set
     */
    public void setGtBelowMean(Double gtBelowMean)
    {
        this.gtBelowMean = gtBelowMean;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + (this.gtBelowMean == null ? 0 : this.gtBelowMean.hashCode());
        result = prime * result + (this.mdbmiageinfId == null ? 0 : this.mdbmiageinfId.hashCode());
        return result;
    }
    @Override
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof MDbmiageinf))
            return false;
        MDbmiageinf other = (MDbmiageinf) obj;
        ...
        if (this.sd == null) {
            ...
            return false;
        if (this.gtBelowMean == null) {
            if (other.gtBelowMean != null)
                return false;
        } else if (!this.gtBelowMean.equals(other.gtBelowMean))
            return false;
        if (this.mdbmiageinfId == null) {
            if (other.mdbmiageinfId != null)
                return false;
        } else if (!this.mdbmiageinfId.equals(other.mdbmiageinfId))
            return false;
        return true;
    }
    ...
    public String toString() {
        return "MDbmiageinf [mdbmiageinfId=" + this.mdbmiageinfId + ", ageYears=" + this.ageYears + ", meanAge=" + this.meanAge
                + ", sample=" + this.sample + ", mean=" + this.mean + ", sd=" + this.sd + ", p10=" + this.p10 + ", p25=" + this.p25 + ", p50=" + this.p50
                + ", p75=" + this.p75 + ", p90=" + this.p90 + ", gtBelowMean=" + this.gtBelowMean + "]";
    }
