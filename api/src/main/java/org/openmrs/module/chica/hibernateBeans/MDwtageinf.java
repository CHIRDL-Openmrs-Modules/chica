...
/**
 * Holds information to store in the chica_md_wtaginf table
 * 
 * @author Seema Sarala
 * @version 1.0
 */
public class MDwtageinf implements java.io.Serializable, MDPercentile {

    private static final long serialVersionUID = 1L;
    // Fields
    private Integer mdwtageinfId = null;
    ...
    /**
     * @return the mdwtageinfId
     */
    public Integer getMdwtageinfId()
    {
        return this.mdwtageinfId;
    }

    /**
     * @param mdwtageinfId the mdwtageinfId to set
     */
    public void setMdwtageinfId(Integer mdwtageinfId)
    {
        this.mdwtageinfId = mdwtageinfId;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + (this.mdwtageinfId == null ? 0 : this.mdwtageinfId.hashCode());
        return result;
    }
    @Override
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof MDwtageinf))
            return false;
        MDwtageinf other = (MDwtageinf) obj;
        ...
        if (this.sd == null) {
            ...
            return false;
        if (this.mdwtageinfId == null) {
            if (other.mdwtageinfId != null)
                return false;
        } else if (!this.mdwtageinfId.equals(other.mdwtageinfId))
            return false;
        return true;
    }
    ...
    public String toString() {
        return "MDwtageinf [mdwtageinfId=" + this.mdwtageinfId + ", ageYears=" + this.ageYears + ", meanAge=" + this.meanAge + ", sample="
                + this.sample + ", mean=" + this.mean + ", sd=" + this.sd + ", p10=" + this.p10 + ", p25=" + this.p25 + ", p50=" + this.p50 + ", p75="
                + this.p75 + ", p90=" + this.p90 + "]";
    }
