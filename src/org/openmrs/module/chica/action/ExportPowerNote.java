		...
		try {
			...
			try {
				...
				while ((line = reader.readLine()) != null) {
					OBX obx = constructor.AddSegmentOBX(conceptName, numberOfOBXSegments.toString(), null, null, line, null,
					    dateTime, hl7Abbreviation, orderRep, numberOfOBXSegments);
					obx.getObservationResultStatus().setValue(resultStatusValue);
					numberOfOBXSegments++;
				}
