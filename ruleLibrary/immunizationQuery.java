 ...
 */
public class immunizationQuery implements Rule {
	
	/**
	 * @see org.openmrs.logic.Rule#eval(LogicContext context, Patient patient, Map<String, Object>
	 *      parameters)
	 */
	public Result eval(LogicContext context, Patient patient, Map<String, Object> parameters) throws LogicException {
		...
		Result result = context.read(patient, context.getLogicDataSource("RMRS"), new LogicCriteria(conceptName));
