        			...
        			if(formId != null){
        				...
        				if(form != null){
        				    ...
        				    if(formName.startsWith("ADHD P")){
								...
								Result result = context.read(patient, context.getLogicDataSource("CHICA"),
								    new LogicCriteria("ParentAssessParentPhone"));

								return result;
        					}
        					if(formName.startsWith("ADHD T")){
        						Result result = context.read(patient, context.getLogicDataSource("CHICA"),
        								new LogicCriteria("TeacherAssessTeacherPhone"));
        						return result;
        					}
