...
<!DOCTYPE html>
<openmrs:require allPrivileges="View Encounters, View Patients, View Concept Classes" otherwise="/module/chica/loginMobile.form" redirect="/module/chica/psfRelationshipJIT.form" />
<html>
<head>
<meta charset="utf-8">
...
<script src="${pageContext.request.contextPath}/moduleResources/chica/psfRelationshipJIT.js" charset="utf-8"></script>
...
<form id="RelationshipForm" method="POST" action="psfRelationshipJIT.form" method="post" enctype="multipart/form-data">
...
<div data-role="page" id="instruction_page" data-theme="b">
    <div data-role="header" >
        <h1 id="formTitle">Additional Information:</h1>
...
<div data-role="page" id="form_completed_page" data-theme="b">
    <div data-role="header" >
        <h1>Relationship Form Completed</h1>
    </div>
    <div data-role="content" style="margin: 0 auto;text-align: center;" >
        <strong><span>The Relationship form has already been completed and successfully submitted.  It cannot be accessed again.</span></strong>
    </div>
    <div data-role="footer" style="text-align:center;padding-bottom:20px;padding-top:20px;">
...
<div id="question_page_1" data-role="page" data-theme="b" type="question_page">
    <div data-role="header" >
        <h1>Informant Relationship with Child Questionnaire:</h1>
        <h1>${patient.givenName}&nbsp;${patient.familyName}</h1>
	    ...
	    <div data-role="fieldcontain" style="margin-top:0px;">
	        <fieldset data-role="controlgroup" data-type="vertical">
				<select name="Informant_1" id="Informant_1" data-native-menu="false">
					<option name="Informant_1" id="Informant_1_0" />
        ...
        <div data-role="fieldcontain" style="margin-top:0px;">
			<fieldset data-role="controlgroup" data-type="vertical">
				<select name="Informant_2" id="Informant_2" multiple="multiple" data-native-menu="false">
				  ...
				  <label for="Informant_2_0">Select</label>
