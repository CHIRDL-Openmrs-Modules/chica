...
<!DOCTYPE html>
<openmrs:require allPrivileges="View Encounters, View Patients, View Concept Classes" otherwise="/module/chica/loginMobile.form" redirect="/module/chica/finishFormsMobileIUHCerner.form" />
<html>
<head>
<meta charset="utf-8">
...
<div id="finished_form" data-url="finished_form" data-role="page">
    ...
    <div data-role="content">
       <form id="complete_form" method="POST" data-ajax="false">
           <div align="center"><p>There are no more forms to complete for ${patient.givenName}&nbsp;${patient.familyName}.  Please click "Finish" and return the device to the MA/Nurse.</p></div>
           <br/>
           <div align="center"><p>No hay m&#225;s formas para completar para ${patient.givenName}&nbsp;${patient.familyName}. Por favor, haga clic en "Finish" y devolver el dispositivo a la MA/Enfermera.</p></div>
           <br/>
           <div align="center">
