...
<div data-role="page" id="confirm_page" data-theme="b">
    ...
    <div data-role="content" >
		...
		<div id="deny_dialog_sp" data-role="popup" data-dismissible="false" data-theme="b" data-overlay-theme="a" >
		    ...
		    <div data-role="content">
		        <span>Si est� seguro de que el paciente incorrecta aparece, pulse 'Aceptar' y devolver el dispositivo a la recepcionista.</span>
		        <div style="margin: 0 auto;text-align: center;">
...
<div id="quit_dialog_sp" data-role="dialog" data-dismissible="false" data-theme="b" data-overlay-theme="c">
    ...
    <div data-role="content">
        <span>Gracias por rellenar el formulario. La enfermera recoger� el aparato de usted.</span>
        <div style="margin: 0 auto;text-align: center;">
...
<div id="question_page_1" data-role="page" data-theme="b" type="question_page">
    <div data-role="header" data-position="fixed">
        <h1>${patient.givenName}&nbsp;${patient.familyName}</h1>
        <a id="langPage1Button" href="#" class="ui-btn-right" onclick="setLanguageFromForm('${patient.givenName}&nbsp;${patient.familyName}', '${patient.birthdate}')">Español</a>
    </div>
...
<div id="question_page_2" data-role="page" data-theme="b" type="question_page">
    <div data-role="header" data-position="fixed">
        <h1>${patient.givenName}&nbsp;${patient.familyName}</h1>
        <a id="langPage2Button" href="#" class="ui-btn-right" onclick="setLanguageFromForm('${patient.givenName}&nbsp;${patient.familyName}', '${patient.birthdate}')">Español</a>
    </div>
...
<div id="question_page_3" data-role="page" data-theme="b" type="question_page">
    <div data-role="header" data-position="fixed">
        <h1>${patient.givenName}&nbsp;${patient.familyName}</h1>
        <a id="langPage3Button" href="#" class="ui-btn-right" onclick="setLanguageFromForm('${patient.givenName}&nbsp;${patient.familyName}', '${patient.birthdate}')">Español</a>
    </div>
...
<div id="question_page_4" data-role="page" data-theme="b" type="question_page">
    <div data-role="header" data-position="fixed">
        <h1>${patient.givenName}&nbsp;${patient.familyName}</h1>
        <a id="langPage4Button" href="#" class="ui-btn-right" onclick="setLanguageFromForm('${patient.givenName}&nbsp;${patient.familyName}', '${patient.birthdate}')">Español</a>
    </div>
...
<div id="question_page_1_sp" data-role="page" data-theme="b" type="question_page">
    <div data-role="header" data-position="fixed">
        <h1>${patient.givenName}&nbsp;${patient.familyName}</h1>
        <a id="langPage1SPButton" href="#" class="ui-btn-right" onclick="setLanguageFromForm('${patient.givenName}&nbsp;${patient.familyName}', '${patient.birthdate}')">English</a>
    </div>
...
<div id="question_page_2_sp" data-role="page" data-theme="b" type="question_page">
    <div data-role="header" data-position="fixed">
        <h1>${patient.givenName}&nbsp;${patient.familyName}</h1>
        <a id="langPage2SPButton" href="#" class="ui-btn-right" onclick="setLanguageFromForm('${patient.givenName}&nbsp;${patient.familyName}', '${patient.birthdate}')">English</a>
    </div>
...
<div id="question_page_3_sp" data-role="page" data-theme="b" type="question_page">
    <div data-role="header" data-position="fixed">
        <h1>${patient.givenName}&nbsp;${patient.familyName}</h1>
        <a id="langPage3SPButton" href="#" class="ui-btn-right" onclick="setLanguageFromForm('${patient.givenName}&nbsp;${patient.familyName}', '${patient.birthdate}')">English</a>
    </div>
...
<div id="question_page_4_sp" data-role="page" data-theme="b" type="question_page">
    <div data-role="header" data-position="fixed">
        <h1>${patient.givenName}&nbsp;${patient.familyName}</h1>
        <a id="langPage4SPButton" href="#" class="ui-btn-right" onclick="setLanguageFromForm('${patient.givenName}&nbsp;${patient.familyName}', '${patient.birthdate}')">English</a>
    </div>
