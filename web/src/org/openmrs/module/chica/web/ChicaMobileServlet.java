		...
		try {
			...
			if (result == null) {
				...
				for (PatientRow row : rows) {
					...
					ServletUtil.writeTag(XML_AGE_IN_YEARS, row.getAgeAtVisitWithoutUnits(), printWriter); // DWE CHICA-884 patient age used to determine if confidentiality pop-up should be displayed
